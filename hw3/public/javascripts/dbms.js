...
var host = "34.83.251.253";    //from GCloud instance (change to match your db)
var database = "CHEESECAKE";  //database name
var user = "root";         //username (change to match your db)
var password = "UPSTU123";  //password (change to match your db, yes this is very poor practice)
